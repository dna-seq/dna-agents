...
from dna_agents.resolver import (
    ensure_resolver_db,
    resolve_variants,
)
...
EVALS_DIR = Path(__file__).resolve().parent / "fixtures" / "evals"
...
def ensembl_db_path() -> Path:
    """Ensure the Ensembl DuckDB is ready (.env loaded by conftest)."""
