...
- **rs3758391**: Promoter region variant. The C allele was more common in
  ...
  Also examined in an Ashkenazi Jewish cohort (PMID 25305471).

- **rs12778366**: Intronic variant. The minor C allele was associated with better
...
- **rs7896005**: Intronic variant. The G allele showed significant effects on
...
- **rs4746720**: 3'UTR variant. The C allele was more common in the Chinese Han
...
- **rs11555236**: Intronic variant in SIRT3. An Italian Northern cohort longitudinal
...
- **rs4980329**: Intronic variant. The same Italian Northern cohort (PMID 23839864)
...
- **rs107251**: Intronic variant. A gene-based analysis across Danish, German,
...
- Use state "protective" for longevity-associated alleles
